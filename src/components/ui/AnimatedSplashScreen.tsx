  ...
  useEffect(() => {
    if (isAppReady) {
      ...
      setTimeout(() => {
        ...
        // Safely trigger unmount on the JS thread after animation completes
        // to avoid Reanimated UI-thread callback unmount crashes.
        setTimeout(() => {
          onAnimationComplete();
        }, 300);
      }, 1000);
...
const styles = StyleSheet.create({
  ...
  ambientGlow: {
    ...
    height: 20,
    borderRadius: 10, 
    backgroundColor: '#3B82F6', // The primary blue color
    zIndex: 1,
    shadowColor: '#a78bfa',
