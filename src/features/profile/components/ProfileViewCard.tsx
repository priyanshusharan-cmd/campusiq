...
export function ProfileViewCard({
  ...
  return (
    <View style={{ position: 'relative', paddingBottom: spacing.xl }}>
      ...
      <Animated.View entering={FadeIn.duration(500)} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 285, borderBottomLeftRadius: 36, borderBottomRightRadius: 36, overflow: 'hidden' }}>
        <LinearGradient
      ...
      {/* User Info Row */}
      <Animated.View entering={FadeInDown.duration(300).springify()} style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.xl, marginTop: spacing.xl }}>
