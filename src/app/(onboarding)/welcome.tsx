  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: colors.bg }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false} bounces={false}>
        {/* Top Header */}
        <LinearGradient colors={isDark ? ['#0B0D14', '#082F49'] : ['#F0F9FF', '#E0F2FE']} style={[styles.headerArea, { paddingTop: insets.top }]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
          {step > 1 && (
...
const styles = StyleSheet.create({
  ...
  glowingOrb: { position: 'absolute', width: 130, height: 130, borderRadius: 65, backgroundColor: '#3B82F6', opacity: 0.2, shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 60, elevation: 20 },
  ...
  submitButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 56, borderRadius: 16, shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 5 },
